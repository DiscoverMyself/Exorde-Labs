...
$HOME/spinner.sh "sleep 5" "..." "Download Binaries, Genesis & Addrbook"
...
$HOME/spinner.sh "sleep 5" "..." "Initialize your node"
...
$HOME/spinner.sh "sleep 3" "..." "Download Genesis & Addrbook file"
...
EOF
$HOME/spinner.sh "sleep 3" "..." "Create Config File"
...
$HOME/spinner.sh "sleep 7" "..." "Syncing your node to the latest block"
...
$HOME/spinner.sh "sleep 3" "..." "Enable Systemctl for Artela services"


# Start The Node
sudo systemctl restart artelad > /dev/null 2>&1
$HOME/spinner.sh "sleep 10" "..." "Running the Node"
...
echo -e "\e[1;32m Check your nodelogs  : \e[0m\e[1;36m${CYAN} artelad status 2>&1 | jq .SyncInfo ${NC}\e[0m"
echo '======================== THANK FOR YOUR SUPPORT ==========================='
echo -e '===============' "\e[0m\e[1;35m Join our TG: t.me/HappyCuanAirdrop \e[0m" '=================='
